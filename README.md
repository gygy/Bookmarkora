...
For manual load (developer mode), get the latest packages (v1.1.97) from [dist/](dist/):

- [Bookmarkora-1.1.97-chrome.zip](dist/Bookmarkora-1.1.97-chrome.zip)
